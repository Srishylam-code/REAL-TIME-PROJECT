...
const CORE_CROPS = [
    { base: 'Rice', ph: [5.5, 7.0], soil: ['Clayey','Loamy','Alluvial'], climate: ['Monsoon','Summer'], baseIncome: 45000, fert: 'NPK 120:60:40 kg/ha', icon: '🌾', details: 'Staple cereal. High water requirement.' },
    { base: 'Wheat', ph: [6.0, 7.5], soil: ['Loamy','Clayey','Black'], climate: ['Winter','Pre-winter'], baseIncome: 38000, fert: 'NPK 100:50:50 kg/ha', icon: '🌿', details: 'Cool season cereal. Sensitive to heat during grain fill.' },
    { base: 'Maize', ph: [5.8, 7.0], soil: ['Sandy','Loamy','Alluvial'], climate: ['Summer','Monsoon','Spring'], baseIncome: 35000, fert: 'NPK 150:75:50 kg/ha', icon: '🌽', details: 'Versatile C4 crop used for food, feed, and fiber.' },
    { base: 'Soybean', ph: [6.0, 7.0], soil: ['Loamy','Black'], climate: ['Monsoon'], baseIncome: 42000, fert: 'NPK 20:60:40 kg/ha', icon: '🫘', details: 'Major nitrogen-fixing legume. Excellent for crop rotation.' },
    { base: 'Cotton', ph: [5.5, 8.5], soil: ['Black','Alluvial'], climate: ['Summer','Monsoon'], baseIncome: 65000, fert: 'NPK 120:60:60 kg/ha', icon: '☁️', details: 'Industrial fiber crop. Thrives in deep moisture-retaining soil.' },
    { base: 'Potato', ph: [5.0, 6.5], soil: ['Sandy','Loamy'], climate: ['Winter','Pre-winter'], baseIncome: 70000, fert: 'NPK 150:100:150 kg/ha', icon: '🥔', details: 'High-value tuber. Needs cool nights and well-aerated soil.' },
    { base: 'Sugarcane', ph: [6.5, 8.0], soil: ['Alluvial','Black','Clayey'], climate: ['Summer','Monsoon'], baseIncome: 85000, fert: 'NPK 250:100:100 kg/ha', icon: '🎋', details: 'Year-long heavy feeder. Requires excellent irrigation.' },
    { base: 'Coffee', ph: [5.0, 6.0], soil: ['Laterite','Red','Loamy'], climate: ['Monsoon'], baseIncome: 120000, fert: 'NPK 160:80:120 kg/ha', icon: '☕', details: 'Perennial plantation crop. Needs high elevation and partial shade.' },
    { base: 'Tea', ph: [4.5, 5.5], soil: ['Red','Laterite'], climate: ['Monsoon'], baseIncome: 110000, fert: 'Sulphate of Ammonia + NPK', icon: '🍵', details: 'Acidic soil specialist. Best grown on well-drained slopes.' },
    { base: 'Banana', ph: [6.5, 7.5], soil: ['Loamy','Alluvial'], climate: ['Summer','Monsoon','Spring'], baseIncome: 90000, fert: 'NPK 200:100:300 g/plant', icon: '🍌', details: 'Tropical rhizome crop. Very heavy Potassium demander.' },
    { base: 'Tomato', ph: [6.0, 6.8], soil: ['Sandy','Loamy'], climate: ['Summer','Winter','Spring','Autumn'], baseIncome: 60000, fert: 'NPK 120:80:100 kg/ha', icon: '🍅', details: 'Requires consistent moisture to prevent blossom end rot.' },
    { base: 'Onion', ph: [6.0, 7.0], soil: ['Sandy','Loamy'], climate: ['Winter','Summer','Autumn'], baseIncome: 55000, fert: 'NPK 100:50:50 kg/ha', icon: '🧅', details: 'Bulbing crop sensitive to waterlogging. Requires loose soils.' },
    { base: 'Grapes', ph: [6.5, 8.5], soil: ['Sandy','Loamy'], climate: ['Summer','Winter','Spring'], baseIncome: 180000, fert: 'NPK + Zinc + Magnesium', icon: '🍇', details: 'Perennial vine. Thrives with dry harvesting periods.' },
    ...
    { base: 'Mango', ph: [5.5, 7.5], soil: ['Alluvial','Red','Loamy'], climate: ['Summer','Spring'], baseIncome: 130000, fert: 'NPK + Organic Manure', icon: '🥭', details: 'Deep-rooted tropical tree. Sensitive to rain during flowering.' },
    { base: 'Barley', ph: [7.0, 8.5], soil: ['Clayey','Loamy','Chalky'], climate: ['Winter','Pre-winter'], baseIncome: 30000, fert: 'NPK 80:40:40 kg/ha', icon: '🌾', details: 'Hardy cereal. High tolerance to saline and alkaline soils.' },
    { base: 'Sorghum', ph: [5.5, 8.5], soil: ['Clayey','Black','Loamy'], climate: ['Summer','Monsoon'], baseIncome: 28000, fert: 'NPK 80:40:40 kg/ha', icon: '🌾', details: 'Highly drought tolerant. Excellent alternative to maize in drylands.' },
    { base: 'Groundnut', ph: [6.0, 6.5], soil: ['Sandy','Loamy'], climate: ['Monsoon','Summer'], baseIncome: 48000, fert: 'NPK 20:40:40 + Gypsum', icon: '🥜', details: 'Legume. Needs loose, sandy soil for proper pegging down.' },
    { base: 'Chickpea', ph: [6.0, 8.0], soil: ['Black','Loamy'], climate: ['Winter','Pre-winter'], baseIncome: 45000, fert: 'NPK 20:40:20 kg/ha', icon: '🫘', details: 'Deep-rooted winter pulse. Thrives on residual soil moisture.' },
    { base: 'Cassava', ph: [4.5, 6.5], soil: ['Sandy','Laterite'], climate: ['Summer','Monsoon'], baseIncome: 40000, fert: 'NPK 60:60:120 kg/ha', icon: '🍠', details: 'Drought-resistant starchy tuber. Highly tolerant to acidic soils.' },
    { base: 'Pineapple', ph: [4.5, 5.5], soil: ['Sandy','Laterite'], climate: ['Monsoon','Summer'], baseIncome: 95000, fert: 'NPK 12:4:12', icon: '🍍', details: 'Acid-loving bromeliad. Excellent for marginal sloping lands.' },
    { base: 'Rubber', ph: [4.0, 6.0], soil: ['Laterite','Red'], climate: ['Monsoon'], baseIncome: 100000, fert: 'NPK 10:10:10', icon: '🌳', details: 'Latex plantation crop. Needs evenly distributed high rainfall.' },
    { base: 'Cabbage', ph: [6.0, 7.5], soil: ['Loamy','Clayey'], climate: ['Winter','Autumn'], baseIncome: 65000, fert: 'NPK 120:60:60 kg/ha', icon: '🥬', details: 'Heavy feeder. Requires high nitrogen and consistent moisture.' },
    { base: 'Carrot', ph: [5.5, 7.0], soil: ['Sandy','Loamy'], climate: ['Winter','Pre-winter'], baseIncome: 58000, fert: 'NPK 80:40:40 kg/ha', icon: '🥕', details: 'Root vegetable. Deep, loose sandy-loam required to prevent forking.' },
    { base: 'Cocoa', ph: [5.0, 7.5], soil: ['Loamy','Alluvial'], climate: ['Monsoon'], baseIncome: 160000, fert: 'NPK + Organic Mulch', icon: '🍫', details: 'Understory tropical tree. Sensitive to wind and drought.' },
    { base: 'Avocado', ph: [6.0, 7.0], soil: ['Loamy','Sandy'], climate: ['Summer','Monsoon'], baseIncome: 200000, fert: 'NPK + Zinc spray', icon: '🥑', details: 'High-value fruit. Extremely susceptible to root rot in poor drainage.' },
    { base: 'Lentil', ph: [6.0, 8.0], soil: ['Loamy','Black'], climate: ['Winter','Pre-winter'], baseIncome: 40000, fert: 'NPK 20:40:20 kg/ha', icon: '🫘', details: 'Hardy winter pulse. Excellent rotational nitrogen fixer.' },
    { base: 'Spinach', ph: [6.5, 7.5], soil: ['Loamy','Sandy'], climate: ['Winter','Spring','Autumn'], baseIncome: 50000, fert: 'NPK 100:50:50 kg/ha', icon: '🥬', details: 'Fast-growing leafy green. Bolts quickly in hot weather.' },
    { base: 'Sunflower', ph: [6.0, 7.5], soil: ['Loamy','Black','Alluvial'], climate: ['Summer','Spring'], baseIncome: 62000, fert: 'NPK 60:40:40 kg/ha', icon: '🌻', details: 'Deep-rooted oilseed. Highly efficient at extracting deep soil moisture.' },
    { base: 'Millet', ph: [5.5, 8.0], soil: ['Sandy','Loamy','Red'], climate: ['Summer','Monsoon'], baseIncome: 25000, fert: 'NPK 40:20:20 kg/ha', icon: '🌾', details: 'Ancient grain. Survives extreme heat and low rainfall.' },
    { base: 'Sweet Potato', ph: [5.5, 6.5], soil: ['Sandy','Loamy'], climate: ['Summer','Monsoon'], baseIncome: 68000, fert: 'NPK 60:60:120 kg/ha', icon: '🍠', details: 'Vining root crop. Low input requirement, highly resilient.' },
    { base: 'Papaya', ph: [6.0, 7.0], soil: ['Loamy','Sandy'], climate: ['Summer','Monsoon'], baseIncome: 110000, fert: 'NPK 200:200:250 g/plant', icon: '🍈', details: 'Fast-growing tropical fruit. Dies quickly in waterlogged soil.' },
    { base: 'Garlic', ph: [6.0, 7.5], soil: ['Loamy','Sandy'], climate: ['Winter','Pre-winter'], baseIncome: 85000, fert: 'NPK 100:50:50 kg/ha', icon: '🧄', details: 'Requires cold vernalization period for good bulb division.' },
    ...
    { base: 'Strawberry', ph: [5.5, 6.5], soil: ['Loamy','Sandy'], climate: ['Winter','Spring','Summer'], baseIncome: 180000, fert: 'NPK 100:80:120 kg/ha', icon: '🍓', details: 'High-value berry. Subject to fungal diseases if poorly ventilated.' },
    ...
    { base: 'Pumpkin', ph: [6.0, 7.5], soil: ['Loamy','Alluvial'], climate: ['Summer','Monsoon'], baseIncome: 55000, fert: 'NPK 80:40:40 kg/ha', icon: '🎃', details: 'Vining squash. Aggressive grower, suppresses weeds well.' },
    { base: 'Chili Pepper', ph: [6.0, 7.0], soil: ['Loamy','Red'], climate: ['Summer','Monsoon','Spring'], baseIncome: 95000, fert: 'NPK 120:60:60 kg/ha', icon: '🌶️', details: 'High capsaicin crop. Sensitive to overwatering and nematodes.' },
    { base: 'Mustard', ph: [6.0, 7.5], soil: ['Loamy','Clayey'], climate: ['Winter','Pre-winter'], baseIncome: 42000, fert: 'NPK 60:40:40 kg/ha', icon: '🌼', details: 'Short duration oilseed. Excellent for late winter sowing.' },
    { base: 'Cucumber', ph: [6.0, 7.0], soil: ['Sandy','Loamy'], climate: ['Summer','Monsoon'], baseIncome: 80000, fert: 'NPK 100:50:50 kg/ha', icon: '🥒', details: 'High water-content climber. Benefits greatly from trellising.' },
    { base: 'Eggplant', ph: [5.5, 6.8], soil: ['Loamy','Alluvial'], climate: ['Summer','Spring'], baseIncome: 65000, fert: 'NPK 100:50:50 kg/ha', icon: '🍆', details: 'Solanaceous vegetable. Heat loving, requires long growing season.' },
    { base: 'Cauliflower', ph: [6.0, 7.0], soil: ['Loamy','Clayey'], climate: ['Winter','Autumn'], baseIncome: 70000, fert: 'NPK 120:60:80 kg/ha', icon: '🥦', details: 'Requires Boron and Molybdenum to prevent hollow stem/whiptail.' },
    ...
    { base: 'Peas', ph: [6.0, 7.5], soil: ['Loamy','Sandy'], climate: ['Winter','Spring'], baseIncome: 55000, fert: 'NPK 20:40:20 kg/ha', icon: '🫛', details: 'Cool-weather legume. Provides early season income.' },
    { base: 'Oats', ph: [5.5, 7.0], soil: ['Loamy','Clayey'], climate: ['Winter','Pre-winter'], baseIncome: 32000, fert: 'NPK 60:30:30 kg/ha', icon: '🌾', details: 'Hardy cereal. Often used as a highly nutritious fodder or cover crop.' },
    ...
    { base: 'Ginger', ph: [5.5, 6.5], soil: ['Loamy','Alluvial'], climate: ['Monsoon'], baseIncome: 140000, fert: 'NPK 100:50:50 kg/ha', icon: '🫚', details: 'Rhizome spice. Requires partial shade and high organic matter.' },
    { base: 'Turmeric', ph: [5.5, 7.5], soil: ['Red','Loamy'], climate: ['Monsoon'], baseIncome: 130000, fert: 'NPK 120:60:60 kg/ha', icon: '🟧', details: 'Curcumin-rich spice. Needs well-drained soil to prevent rhizome rot.' },
    { base: 'Vanilla', ph: [6.0, 7.0], soil: ['Loamy','Laterite'], climate: ['Monsoon'], baseIncome: 300000, fert: 'Organic Mulch / Leaf litter', icon: '🪴', details: 'High-value climbing orchid. Requires manual pollination.' }
];
...
function getEngineFerts(cropBase) {
    ...
    return finalRecommendations.map(crop => ({
        ...
        baseCrop:             crop.baseCrop || crop.base,
        icon:                 crop.icon,
        score:                crop.score,
